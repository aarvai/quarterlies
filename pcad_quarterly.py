...
def pcad_LTTs(start, stop):
    ...
    LTTplot('AFLCAAH', start=start, stop=stop, plot_limits=False, cust_title='FLCA SOH - AFLCAAH', ylim=[4, 6.5], subplot=[2,1,2], samefig=True, saveas='ACA_TEMP_SOH.png')
    ...
    LTTplot('DP_CSS4_NPM_SUN', start=start, stop=stop, plot_limits=False, plot_means=False, plot_maxes=False, cust_title='MIN CSS-4 COUNTS IN NPM ONLY', cust_unit='COUNTS', subplot=[4,1,4], samefig=True, saveas='RW_TORQUE_CURR_2.png')      
    ...
    LTTplot('DP_PITCH_FSS', cust_title='FSS PITCH ANGLE', cust_unit='DEG', start=start, stop=stop, plot_limits=False, samefig=True, subplot=[2,1,2], saveas='FSS_ROLL_PITCH.png')
    #
    LTTplot('AOALPANG', start=start, stop=stop, plot_limits=False, subplot=[2,1,1], savefig=False)
    LTTplot('AOBETANG', start=start, stop=stop, plot_limits=False, subplot=[2,1,2], samefig=True, saveas='FSS_ALPHA_BETA.png')

    # FSS / CSS Sun Vector Difference ----------------
    LTTplot('DP_FSS_CSS_ANGLE_DIFF', start=start, stop=stop, plot_limits=False, saveas='FSS_CSS_ANGLE_DIFF.png')

    # Solar Array Angles -----------------------------
    #
    LTTplot('AOSARES1', start=start, stop=stop, plot_limits=False, subplot=[2,1,1], savefig=False)
    LTTplot('AOSARES2', start=start, stop=stop, plot_limits=False, subplot=[2,1,2], samefig=True, saveas='SA_RES_ANGLES.png')
    ...
    if Time.DateTime(start) < Time.DateTime('2003:200'):
        ...
        LTTplot('AIRU1G2I', start=start, stop=stop_iru1, plot_limits=False, subplot=[2,1,2], samefig=True, saveas='IRU_1_CURRENTS.png')
        #
        ...
        LTTplot('AIRU1G2T', start=start, stop=stop_iru1, plot_limits=False, plot_mins=False, plot_maxes=False, cust_title='MEAN IRU-1 GYRO #2 TEMP - AIRU1G2T', subplot=[2,1,2], samefig=True, saveas='IRU_1_TEMPS_1.png')
        #
        ...
        LTTplot('AIRU1VFT', start=start, stop=stop_iru1, plot_limits=False, plot_mins=False, plot_maxes=False, cust_title='MEAN IRU-1 VFC TEMPERATURE - AIRU1VFT', subplot=[2,1,2], samefig=True, saveas='IRU_1_TEMPS_2.png')
    ...
    if Time.DateTime(stop) > Time.DateTime('2003:201'):
        ...
        LTTplot('AIRU2G2I', start=start_iru1, stop=stop, plot_limits=False, subplot=[2,1,2], samefig=True, saveas='IRU_2_CURRENTS.png')
        #
        ...
        LTTplot('AIRU2G2T', start=start_iru1, stop=stop, plot_limits=False, plot_mins=False, plot_maxes=False, cust_title='MEAN IRU-2 GYRO #2 TEMP - AIRU2G2T', subplot=[2,1,2], samefig=True, saveas='IRU_2_TEMPS_1.png')
        #
        ...
        LTTplot('AIRU2VFT', start=start_iru1, stop=stop, plot_limits=False, plot_mins=False, plot_maxes=False, cust_title='MEAN IRU-2 VFC TEMPERATURE - AIRU2VFT', subplot=[2,1,2], samefig=True, saveas='IRU_2_TEMPS_2.png')
    ...
    LTTplot('AOGBIAS3', start=start, stop=stop, plot_limits=False, cust_unit='ARCSEC/SEC', cust_mult=3600*180/pi, subplot=[3,1,3], samefig=True, saveas='IRU_GRYO_BIASES.png')
    ...
    LTTplot('AORWSPD3', start=start, stop=stop, plot_limits=False, cust_unit='RPM', cust_mult=60/(pi*2), subplot=[3,1,3], samefig=True, saveas='RW_SPEEDS_1.png')    
    #
    ...
    LTTplot('AORWSPD6', start=start, stop=stop, plot_limits=False, cust_unit='RPM', cust_mult=60/(pi*2), subplot=[3,1,3], samefig=True, saveas='RW_SPEEDS_2.png')    
    ...
    LTTplot('ARWA3BT', start=start, stop=stop, plot_limits=False, subplot=[3,1,3], samefig=True, saveas='RW_TEMPS_1.png')    
    #
    ...
    LTTplot('ARWA6BT', start=start, stop=stop, plot_limits=False, subplot=[3,1,3], samefig=True, saveas='RW_TEMPS_2.png')      
    ...
    LTTplot('AWD3TQI', start=start, stop=stop, plot_limits=False, subplot=[3,1,3], samefig=True, saveas='RW_TORQUE_CURR_1.png')    
    #
    ...
    LTTplot('AWD6TQI', start=start, stop=stop, plot_limits=False, subplot=[3,1,3], samefig=True, saveas='RW_TORQUE_CURR_2.png')  
    ...
    LTTplot('AORWCMD3', start=start, stop=stop, plot_limits=False, subplot=[3,1,3], plot_mins=False, plot_maxes=False, cust_title='MEAN RW #3 COMMANDED DRAG TORQUE - AORWCMD3', samefig=True, saveas='RW_DRAG_TORQUE_1.png')   
    #
    ...
    LTTplot('AORWCMD6', start=start, stop=stop, plot_limits=False, subplot=[3,1,3], plot_mins=False, plot_maxes=False, cust_title='MEAN RW #6 COMMANDED DRAG TORQUE - AORWCMD6', samefig=True, saveas='RW_DRAG_TORQUE_2.png')      
    ...
    LTTplot('AWD3CV5V', start=start, stop=stop, plot_limits=False, subplot=[3,1,3], plot_mins=False, plot_maxes=False, cust_title='MEAN WDE-3 +5V CONVERTER VOLTAGE - AWD3CV5V', samefig=True, saveas='CONV_VOLT_WDE_1.png') 
    #
    ...
    LTTplot('AWD6CV5V', start=start, stop=stop, plot_limits=False, subplot=[3,1,3], plot_mins=False, plot_maxes=False, cust_title='MEAN WDE-6 +5V CONVERTER VOLTAGE - AWD6CV5V', samefig=True, saveas='CONV_VOLT_WDE_2.png') 
    ...
    LTTplot('AFSSPC1V', start=start, stop=stop, plot_limits=False, subplot=[3,1,3], plot_mins=False, plot_maxes=False, cust_title='MEAN FSS-A +5V CONVERTER VOLTAGE - AFSSPC1V', samefig=True, saveas='CONV_VOLT_OTHER_1.png') 
    #
    ...
    LTTplot('AIOAP5CV', start=start, stop=stop, plot_limits=False, subplot=[3,1,3], plot_mins=False, plot_maxes=False, cust_title='MEAN IOE-A +5V CONVERTER VOLTAGE - AIOAP5CV', samefig=True, saveas='CONV_VOLT_OTHER_2.png')   
    #
    ...
    LTTplot('AVD1CV5V', start=start, stop=stop, plot_limits=False, subplot=[3,1,2], plot_mins=False, plot_maxes=False, cust_title='MEAN VDE-A +5V CONVERTER VOLTAGE - AVD1CV5V', samefig=True, saveas='CONV_VOLT_OTHER_3.png')    
    ...
    LTTplot('AOCPESTC', start=start, stop=stop, plot_limits=False, subplot=[2,1,2], cust_title='CPE ERROR COUNT - AOCPESTC', samefig=True, saveas='EPIC_CPE.png') 
