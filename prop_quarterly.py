...
def prop_LTTs(start, stop):
    LTTplot('pcm01t', start=start, stop=stop, ylim=[50,170], limit_lines=False, yellow=[85,145], red=[80,160])
    LTTplot('pcm02t', start=start, stop=stop, ylim=[50,170], limit_lines=False, yellow=[85,145], red=[80,160])
    LTTplot('pcm03t', start=start, stop=stop, ylim=[50,170], limit_lines=False, yellow=[65,145], red=[60,160])
    LTTplot('pcm04t', start=start, stop=stop, ylim=[50,170], limit_lines=False, yellow=[65,145], red=[60,160])
    ...
    LTTplot('pffp01t', start=start, stop=stop, ylim=[30,250], limit_lines=False, yellow=[47,200],red=[40,240])
    LTTplot('pftank1t', start=start, stop=stop, ylim=[30,130], limit_lines=False, yellow=[47,100], red=[40,120])
    LTTplot('pftank2t', start=start, stop=stop, ylim=[30,130], limit_lines=False, yellow=[47,100], red=[40,120])
    LTTplot('pftankip', start=start, stop=stop, limit_lines=False, yellow=[270, 296], red=[240, 300])
    LTTplot('pftankop', start=start, stop=stop, limit_lines=False, yellow=[270, 296], red=[240, 300])
    LTTplot('phetankp', start=start, stop=stop)
    LTTplot('phetankt', start=start, stop=stop, ylim=[-20,150], limit_lines=False, yellow=[0,130], red=[-10,140])
    LTTplot('phofp1t', start=start, stop=stop, limit_lines=False, yellow=[35, 110], red=[30, 120])
    ...
    LTTplot('plaev1at', start=start, stop=stop, ylim=[30,250], limit_lines=False, yellow=[47,225], red=[40,240])
    LTTplot('plaev1bt', start=start, stop=stop, ylim=[30,250], limit_lines=False, yellow=[47,225], red=[40,240])
    LTTplot('plaev2at', start=start, stop=stop, ylim=[30,250], limit_lines=False, yellow=[47,225], red=[40,240])
    LTTplot('plaev2bt', start=start, stop=stop, ylim=[30,250], limit_lines=False, yellow=[47,225], red=[40,240])
    LTTplot('plaev3at', start=start, stop=stop, ylim=[30,250], limit_lines=False, yellow=[47,225], red=[40,240])
    LTTplot('plaev3bt', start=start, stop=stop, ylim=[30,250], limit_lines=False, yellow=[47,225], red=[40,240])
    LTTplot('plaev4at', start=start, stop=stop, ylim=[30,250], limit_lines=False, yellow=[-200,225], red=[-300,240])
    LTTplot('plaev4bt', start=start, stop=stop, ylim=[30,250], limit_lines=False, yellow=[47,225], red=[40,240])
    LTTplot('pline01t', start=start, stop=stop)
    LTTplot('pline02t', start=start, stop=stop, ylim=[30,190], limit_lines=False, yellow=[47,170], red=[40,180])
    LTTplot('pline03t', start=start, stop=stop, ylim=[29.5,190], limit_lines=False, yellow=[42.5,170], red=[39.5,180])
    LTTplot('pline04t', start=start, stop=stop, ylim=[29.5,190], limit_lines=False, yellow=[42.5,170], red=[39.5,180])
    LTTplot('pline05t', start=start, stop=stop, ylim=[30,250], limit_lines=False, yellow=[47,200], red=[40,240])
    LTTplot('pline06t', start=start, stop=stop)
    LTTplot('pline07t', start=start, stop=stop, ylim=[30,250], limit_lines=False, yellow=[47,200], red=[40,240])
    ...
    LTTplot('pm2thv1t', start=start, stop=stop, ylim=[30,250], limit_lines=False, yellow=[47,195], red=[40,240])
    ...
    LTTplot('pmfp01t', start=start, stop=stop, ylim=[30,150], limit_lines=False, yellow=[47,130], red=[40,140])
    ...
    LTTplot('pr1tv01t', start=start, stop=stop, limit_lines=False, yellow=[40, 195], red=[37, 240])
    LTTplot('pr1tv02t', start=start, stop=stop, limit_lines=False, yellow=[40, 195], red=[37, 240])
    LTTplot('pr2tv01t', start=start, stop=stop, limit_lines=False, yellow=[40, 195], red=[37, 240])
    LTTplot('pr2tv02t', start=start, stop=stop, limit_lines=False, yellow=[40, 195], red=[37, 240])
